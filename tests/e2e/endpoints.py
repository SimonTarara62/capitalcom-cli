...
COVERAGE["market.nav_node"].sdk_neg = f"{_SN}::test_sdk_bad_identifier_raises[market.nav_node]"
...
COVERAGE["session.ping"].sdk_neg = f"{_SN}::test_sdk_auth_failure_raises[session.ping]"
COVERAGE["session.switch"].sdk_neg = f"{_SN}::test_sdk_auth_failure_raises[session.switch]"
COVERAGE["session.logout"].sdk_neg = f"{_SN}::test_sdk_auth_failure_raises[session.logout]"
COVERAGE["session.login"].sdk_neg = f"{_SN}::test_sdk_auth_failure_raises[session.login]"
COVERAGE["account.list"].sdk_neg = f"{_SN}::test_sdk_auth_failure_raises[account.list]"
COVERAGE["account.prefs_get"].sdk_neg = f"{_SN}::test_sdk_auth_failure_raises[account.prefs_get]"
COVERAGE["account.history_activity"].sdk_neg = f"{_SN}::test_sdk_auth_failure_raises[account.history_activity]"
COVERAGE["account.history_transactions"].sdk_neg = f"{_SN}::test_sdk_auth_failure_raises[account.history_transactions]"
COVERAGE["market.search"].sdk_neg = f"{_SN}::test_sdk_auth_failure_raises[market.search]"
COVERAGE["market.sentiment"].sdk_neg = f"{_SN}::test_sdk_auth_failure_raises[market.sentiment]"
COVERAGE["market.nav_root"].sdk_neg = f"{_SN}::test_sdk_auth_failure_raises[market.nav_root]"
COVERAGE["position.list"].sdk_neg = f"{_SN}::test_sdk_auth_failure_raises[position.list]"
COVERAGE["order.list"].sdk_neg = f"{_SN}::test_sdk_auth_failure_raises[order.list]"
COVERAGE["watchlist.list"].sdk_neg = f"{_SN}::test_sdk_auth_failure_raises[watchlist.list]"
COVERAGE["stream.prices"].sdk_neg = f"{_SN}::test_sdk_stream_auth_failure[stream.prices]"
COVERAGE["stream.candles"].sdk_neg = f"{_SN}::test_sdk_stream_auth_failure[stream.candles]"
COVERAGE["stream.alerts"].sdk_neg = f"{_SN}::test_sdk_stream_auth_failure[stream.alerts]"
COVERAGE["stream.portfolio"].sdk_neg = f"{_SN}::test_sdk_stream_auth_failure[stream.portfolio]"
